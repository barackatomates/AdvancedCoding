...
class CString
{
	...
	public:
		...
		CString(const CString& otha)
		{
			...
			memcpy(this->S, otha.S,strlen(otha.S));
		}
		...
		{  
			...
			strcpy(temp, S);
			strcat(temp,otha.S);
			return CString(temp);	//Is this even legal ?
		}
